...
public class JefeBodegaAsignado extends DomainEvent {
    ...
    public JefeBodegaAsignado(JefeBodegaId jefeBodegaId, Nombres nombres, Apellidos apellidos,
            FechaIngreso fechaIngreso) {
        super("empleados.jefebodegaasignado");
