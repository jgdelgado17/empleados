...
public class BodegueroDesAsignadoAjefeBodega extends DomainEvent {
    ...
    public BodegueroDesAsignadoAjefeBodega(BodegueroId bodegueroId, Nombres nombres, Apellidos apellidos,
            FechaIngreso fechaIngreso, Horario horario, JefeBodegaId jefeBodegaId) {
        super("empleados.bodeguerodesasignadoajefebodega");
