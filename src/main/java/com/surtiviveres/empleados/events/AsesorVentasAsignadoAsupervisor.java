...
public class AsesorVentasAsignadoAsupervisor extends DomainEvent {
    ...
    public AsesorVentasAsignadoAsupervisor(AsesorDeVentasId asesorDeVentasId, Nombres nombres,
            Apellidos apellidos, FechaIngreso fechaIngreso, Horario horario, SupervisorId supervisorId) {
        super("empleados.asesorventasasignadoasupervisor");
